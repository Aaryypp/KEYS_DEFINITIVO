...
public class Validar {
    ...
    public static void numero(JTextField texto, int longitud) {
        try {
    ...
    public static void letras(JTextField texto, int longitud) {
        try {
            texto.addKeyListener(new KeyAdapter() {
                @Override
                public void keyTyped(KeyEvent e) {
     ...
     public static void letras_no_especiales(JTextField texto, int longitud) {
        try {
            texto.addKeyListener(new KeyAdapter() {
                @Override
                public void keyTyped(KeyEvent e) {
    ...
    public static void letras_espacios(JTextField texto, int longitud) {
        try {
            texto.addKeyListener(new KeyAdapter() {
                @Override
                public void keyTyped(KeyEvent e) {
                    ...
                    if (!(minusculas || mayusculas ||ñ || VocMinTil || VocMayTil || espacio)) {
                        e.consume();
                    }
                    if (texto.getText().length() >= longitud) {
                        e.consume();
    ...
    public static void contraseña(JTextField texto, int longitud) {
        try {
            texto.addKeyListener(new KeyAdapter() {
                @Override
    ...
    public static boolean licencia(String s) {
        Pattern p = Pattern.compile("^\\d{10}$");
        Matcher m = p.matcher(s);
        return (m.matches());
    }

    public static boolean RUC(String s) {
        Pattern p = Pattern.compile("^\\d{13}$");
        Matcher m = p.matcher(s);
        return (m.matches());
    }

    public static void descripcion(JTextArea texto, int longitud) {
        try {
            texto.addKeyListener(new KeyAdapter() {
                @Override
    ...
    public static boolean edad(Date nacimiento) {
        Date hoy = new Date();
